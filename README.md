...
L<DBIO::Oracle::Deploy> orchestrates test-deploy-and-compare:

1. Introspect live database via USER_* views (L<DBIO::Oracle::Introspect>)
2. Deploy desired schema to a temporary tablespace
3. Introspect the temporary schema the same way
4. Diff source vs target (L<DBIO::Oracle::Diff>)
...
- Perl 5.36+
- L<DBD::Oracle|https://metacpan.org/pod/DBD::Oracle>
- DBIO core
